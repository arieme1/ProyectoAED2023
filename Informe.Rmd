...
En este proyecto de Análisis Exploratorio de Datos, haremos un estudio de las precipitaciones en España a lo largo de los últimos años. Los datos para conseguir un buen análisis de este tema, los hemos obtenido de la página de Instituto Nacional de Estadística (*enlace*).

Con estos datos, queremos hacer un análisis de la variación de las precipitaciones a lo largo de los últimos años en todo el territorio español, ver la relación entre las distintas variables climáticas y evaluar si existen correlaciones significativas entre las mismas. Por último, haremos un análisis geoespacial, que nos ayudará a tener una visión más clara sobre todo este estuido.
...
En este dataset tenemos una primera variable, `Indicativo`, y para cada indicativo tenemos 13 columnas con datos relativos al mismo, uno por mes y el anual, que es la media de todas las mediciones del año. Para construir este dataset, y por analogía el de los otros años, hemos tenido en consideración las siguientes:
...
>>>>>>> 172fe2f21999c584bf16b5f46c9110f7830978b5
